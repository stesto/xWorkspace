...
<html class="h-100" lang="en">
	<head>
		...
		<script src="https://unpkg.com/vue@3"></script><script>
			var arbeitsplaetze = 
			<?php
				echo file_get_contents('./arbeitsplaetze.json');
			?>
		</script>
		<script src="js/index.js"></script>
	</head>
	<body id="vue-body" class="d-flex flex-column h-100">
		<!-- Navbar -->
				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<li v-for="platz in getFilteredRooms" class="list-group-item  align-items-center">
								<div class="d-flex justify-content-between">
									<div class="container">
										<h6><b>{{ platz.raum }}</b></h6>
										<h6>{{ platz.ort }}</h6>
										<span v-for="feature in platz.features" class="badge text-bg-secondary rounded-pill">{{ feature }}</span>
									</div>
