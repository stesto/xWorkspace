...
<head>
    ...
    <link rel="stylesheet" href="css/style_login_neu.css" />
            ...
            <div class="content">
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type="password" placeholder="Gib dein Passwort ein" name="psw" v-model="password" v-on:keydown.enter="login">
                    </div>
                    <div style="display: flex; justify-content: space-between; margin-top: 40px;">
                        <a href="form.php">
                            <button class="action-button">Registrieren</button>
                        </a>
                        <button class="action-button" v-on:click="login" :disabled="nameMissing || passwordMissing || loading">Login</button>
                    </div>
                </div>
            </div>
        </div>
